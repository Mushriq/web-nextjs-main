          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4 lg:w-1/2">
              <SectionTitle
                ...
                paragraph="Research progress is often hindered by manual workflows that limit the scope of exploration and introduce confounding variability. We address these challenges with integrated robotic systems for automated liquid handling, multi-modal plate readouts, and high-content imaging, enabling complex screens with improved data consistency."
                mb="40px"
              />

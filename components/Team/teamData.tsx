...
const teamData: TeamMember[] = [
  {
    id: 1,
    name: "Mushriq Al-Jazrawe, PhD",
    role: "Scientific Director",
    photo: "/images/team/mm.jpg",
    github: "",
